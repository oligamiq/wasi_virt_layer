...
const FILES: VFSConstNormalFiles<F, 5> = ::wasip1_virtual_layer::wasi::file::constant::lfs_raw::VFSConstNormalFiles::new({
    const COUNT: usize = {
        let mut count = 0;
        count += 1;
        count += 1;
...
impl ::const_struct::PrimitiveTraits for FilesTy {
    type DATATYPE = VFSConstNormalFiles<F, 5>;
...
const FILES2: NormalFILES2 = ::wasip1_virtual_layer::wasi::file::constant::lfs_raw::VFSConstNormalFiles::new({
    const COUNT: usize = {
        let mut count = 0;
        count += 1;
        count += 1;
    ...
    const EMPTY_ARR: [&'static str; COUNT] = {
        let mut empty_arr = ::wasip1_virtual_layer::binary_map::StaticArrayBuilder::new();
        empty_arr.push((0 + 1, "/root/root.txt"));
        empty_arr.push((0, "/root"));
        empty_arr.push((0 + 1, "./hey"));
        empty_arr.push((0 + 1 + 1, "./hello/world"));
        empty_arr.push((0 + 1 + 1, "./hello/everyone"));
        empty_arr.push((0 + 1, "./hello"));
        empty_arr.push((0, "."));
        empty_arr.push((0 + 1, "~/home"));
        empty_arr.push((0 + 1, "~/user"));
        empty_arr.push((0, "~"));
        let _ = empty_arr.build();
        custom_sort(empty_arr)
    };
    static_array
        .push((
            ...
            (
                ...
                ::wasip1_virtual_layer::wasi::file::constant::lfs_raw::VFSConstNormalInode::File(
                    { F::new("This is root") },
                    get_parent(EMPTY_ARR, "/root/root.txt", &static_array).unwrap(),
                ),
            ),
        ));
    static_array
        .push((
            ...
            (
                ...
                ::wasip1_virtual_layer::wasi::file::constant::lfs_raw::VFSConstNormalInode::Dir(
                    ...
                    get_parent(EMPTY_ARR, "/root", &static_array),
                ),
            ),
        ));
    static_array
    ...
    static_array
        .push((
            ...
            (
                ...
                ::wasip1_virtual_layer::wasi::file::constant::lfs_raw::VFSConstNormalInode::File(
                    { F::new("This is home") },
                    get_parent(EMPTY_ARR, "~/home", &static_array).unwrap(),
                ),
            ),
        ));
    static_array
        .push((
            ...
            (
                ...
                ::wasip1_virtual_layer::wasi::file::constant::lfs_raw::VFSConstNormalInode::File(
                    { F::new("This is user") },
                    get_parent(EMPTY_ARR, "~/user", &static_array).unwrap(),
                ),
            ),
        ));
    static_array
    ...
    const PRE_OPEN: [usize; PRE_OPEN_COUNT] = {
        let mut static_array = ::wasip1_virtual_layer::binary_map::StaticArrayBuilder::new();
        static_array.push(get_self(EMPTY_ARR, "/root"));
        static_array.push(get_self(EMPTY_ARR, "."));
        static_array.push(get_self(EMPTY_ARR, "~"));
        static_array.build()
    };
...
pub struct Files2Ty;
#[automatically_derived]
impl ::const_struct::PrimitiveTraits for Files2Ty {
    type DATATYPE = NormalFILES2;
    const __DATA: <Self as ::const_struct::PrimitiveTraits>::DATATYPE = FILES2;
}
#[allow(dead_code)]
