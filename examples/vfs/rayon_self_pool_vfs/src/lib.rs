...
impl Guest for Starter {
    ...
    fn start() {
        rayon_self_pool_target::_start();
    }

    fn main() {
        // rayon_self_pool_target::_reset();
        rayon_self_pool_target::_start();
        // println!("Starting _main...");
        rayon_self_pool_target::_main();
        // println!("_main done.");
    }
}
...
import_wasm!(rayon_self_pool_target);
...
mod fs {
    ...
    plug_fs!(&VIRTUAL_FILE_SYSTEM, rayon_self_pool_target, self);
}
