...
const imports = {
	...
	"wasip1-vfs": {
		__wasip1_vfs_test_threads_memory_copy_to: (...args) => {
			console.log(
				"[wasip1_vfs] __wasip1_vfs_test_threads_memory_copy_to",
				...args,
			);
		},
		...
		__wasip1_vfs_test_threads_memory_director: (...args) => {
			console.log(
				"[wasip1_vfs] __wasip1_vfs_test_threads_memory_director",
				...args,
			);
		},
		...
		__wasip1_vfs_test_threads_memory_trap: (...args) => {
			console.log(
				"[wasip1_vfs] __wasip1_vfs_test_threads_memory_trap",
				...args,
			);
		},
		__wasip1_vfs_test_threads_wasi_thread_start: (...args) => {
			console.log(
				"[wasip1_vfs] __wasip1_vfs_test_threads_wasi_thread_start",
				...args,
			);
		},
		...
		__wasip1_vfs_test_threads___main_void: (...args) => {
			console.log(
				"[wasip1_vfs] __wasip1_vfs_test_threads___main_void",
				...args,
			);
		},
	},
	...
	wasi: {
		__wasip1_vfs_wasi_thread_spawn_test_threads: (...args) => {
			console.log(
				"[wasip1-threads] __wasip1_vfs_wasi_thread_spawn_test_threads",
				...args,
			);
			throw new Error("thread spawn not implemented");
		},
