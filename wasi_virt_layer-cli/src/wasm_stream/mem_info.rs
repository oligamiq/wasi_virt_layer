...
pub fn set_memory_index(op: &mut wasm_encoder::Instruction, index: u32) {
    match op {
        ...
        wasm_encoder::Instruction::I64Load(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::F32Load(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::F64Load(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32Load8S(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32Load8U(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32Load16S(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32Load16U(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64Load8S(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64Load8U(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64Load16S(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64Load16U(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64Load32S(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64Load32U(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32Store(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64Store(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::F32Store(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::F64Store(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32Store8(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32Store16(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64Store8(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64Store16(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64Store32(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::MemoryAtomicNotify(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::MemoryAtomicWait32(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::MemoryAtomicWait64(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicLoad(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicLoad(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicLoad8U(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicLoad16U(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicLoad8U(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicLoad16U(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicLoad32U(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicStore(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicStore(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicStore8(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicStore16(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicStore8(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicStore16(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicStore32(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicRmwAdd(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmwAdd(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicRmw8AddU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicRmw16AddU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmw8AddU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmw16AddU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmw32AddU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicRmwSub(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmwSub(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicRmw8SubU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicRmw16SubU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmw8SubU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmw16SubU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmw32SubU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicRmwAnd(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmwAnd(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicRmw8AndU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicRmw16AndU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmw8AndU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmw16AndU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmw32AndU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicRmwOr(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmwOr(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicRmw8OrU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicRmw16OrU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmw8OrU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmw16OrU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmw32OrU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicRmwXor(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmwXor(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicRmw8XorU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicRmw16XorU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmw8XorU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmw16XorU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmw32XorU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicRmwXchg(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmwXchg(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicRmw8XchgU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicRmw16XchgU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmw8XchgU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmw16XchgU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmw32XchgU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicRmwCmpxchg(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmwCmpxchg(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicRmw8CmpxchgU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I32AtomicRmw16CmpxchgU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmw8CmpxchgU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmw16CmpxchgU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::I64AtomicRmw32CmpxchgU(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::V128Load(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::V128Load8x8S(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::V128Load8x8U(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::V128Load16x4S(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::V128Load16x4U(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::V128Load32x2S(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::V128Load32x2U(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::V128Load8Splat(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::V128Load16Splat(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::V128Load32Splat(memarg) => memarg.memory_index = index,
        wasm_encoder::Instruction::V128Load64Splat(memarg) => memarg.memory_index = index,
...
pub fn is_atomic_op(op: &wasmparser::Operator) -> bool {
    let name = format!("{:?}", op);
