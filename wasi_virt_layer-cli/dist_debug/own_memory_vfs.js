...
export function instantiate(getCoreModule, imports, instantiateCore = WebAssembly.instantiate) {
  ...
  function _lowerImportBackwardsCompat(args) {
    ...
    const module0 = getCoreModule('own_memory_vfs.core.wasm');
    ...
    let gen = (function* _initGenerator () {
      ...
      _trampoline3.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.schedYieldImport';
      ...
      _trampoline5.fnName = 'wasip1-vfs:host/virtual-file-system-wasip1-core#Wasip1.procExitImport';
      let exports0;
      let memory0;
      let realloc0;
      let realloc0Async;
      ...
      function world() {
        _debugLog('[iface="world", function="world"][Instruction::CallWasm] enter', {
          funcName: 'world',
          paramCount: 0,
          async: false,
          postReturn: false,
        ...
        _debugLog('[iface="world", function="world"][Instruction::Return]', {
          funcName: 'world',
          paramCount: 0,
          async: false,
          postReturn: false
      ...
      function addEnv(arg0) {
        ...
        _debugLog('[iface="add-env", function="add-env"][Instruction::Return]', {
          funcName: 'add-env',
          paramCount: 0,
          async: false,
          postReturn: false
      ...
      function getEnvs() {
        _debugLog('[iface="get-envs", function="get-envs"][Instruction::CallWasm] enter', {
          funcName: 'get-envs',
          paramCount: 0,
          async: false,
          postReturn: true,
        ...
        _debugLog('[iface="get-envs", function="get-envs"][Instruction::Return]', {
          funcName: 'get-envs',
          paramCount: 1,
          async: false,
          postReturn: true
      ...
      ({ exports: exports0 } = yield instantiateCore(yield module0, {
        'wasip1-vfs:host/virtual-file-system-wasip1-core': {
          ...
          '[static]wasip1.proc-exit-import': trampoline5,
          '[static]wasip1.random-get-import': trampoline2,
          '[static]wasip1.sched-yield-import': trampoline3,
        },
      }));
      ...
      postReturn0 = exports0['cabi_post_get-envs'];
      
      try {
        postReturn0Async = WebAssembly.promising(exports0['cabi_post_get-envs']);
      } catch(err) {
        postReturn0Async = exports0['cabi_post_get-envs'];
      }
      
      exports0World = exports0.world;
      exports0Main = exports0.main;
      exports0AddEnv = exports0['add-env'];
      exports0GetEnvs = exports0['get-envs'];
      
      return { addEnv, getEnvs, main, world,  };
    })();
