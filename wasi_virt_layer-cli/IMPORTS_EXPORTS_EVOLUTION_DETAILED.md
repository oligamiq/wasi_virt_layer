...
| Module | Name |
|---|---|
| `"wasip1-vfs"` | `"__wasip1_vfs_test_wasm_memory_director"` |
...
| `"wasip1-vfs"` | `"__wasip1_vfs_test_wasm_memory_trap"` |
...
| `"__wasip1_vfs_test_wasm_memory_trap_anchor"` |
...
| `"__wasip1_vfs_flag_info_target_memory_type_Single"` |
| `"__wasip1_vfs_flag_info_unstable_print_debug_false"` |
...
### Stage: `merged.opt.adjusted.opt.opt.wasm`
...
### Stage: `merged.opt.adjusted.opt.opt.adjusted.wasm`
...
### Stage: `merged.opt.adjusted.opt.opt.adjusted.opt.wasm`
...
| `"__wasip1_vfs_test_wasm__start"` |
| `"_____debug_left___wasip1_vfs_test_wasm___main_void"` |
| `"__wasip1_vfs_test_wasm_memory_director_anchor"` |
