...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn clock_res_get_import_wrap(clock_id: i32, resolution_ptr: i32) -> i32 {
    Wasip1::clock_res_get_import(clock_id, resolution_ptr)
}

#[unsafe(no_mangle)]
pub unsafe extern "C" fn fd_advise_import_wrap(fd: i32, offset: i64, len: i64, advice: i8) -> i32 {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn sock_accept_import_wrap(fd: i32, flags: i16, new_sock_fd_ptr: i32) -> i32 {
