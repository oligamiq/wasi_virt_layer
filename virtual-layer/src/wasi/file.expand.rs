mod ex {
    ...
    const FILES: VFSConstNormalFiles<WasiConstFile<&'static str>, 9> =
        crate::wasi::file::VFSConstNormalFiles::new({
            ...
            static_array.push((
                "/root/root.txt",
                crate::wasi::file::VFSConstNormalInode::File((
            ...
            static_array.push((
                "/root",
                crate::wasi::file::VFSConstNormalInode::Dir(get_child_range(
                    empty_arr,
                    "/root",
                    &static_array,
                )),
