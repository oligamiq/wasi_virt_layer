...
function trampoline1(arg0, arg1) {
  console.error(`[module="[static]wasip1.environ-sizes-get-import", function="[static]wasip1.environ-sizes-get-import"] call environ-count=${arguments[0]}, environ-size=${arguments[1]}`);
  const ret = Wasip1.environSizesGetImport(arg0, arg1);
  console.error(`[module="[static]wasip1.environ-sizes-get-import", function="[static]wasip1.environ-sizes-get-import"] return result=${toResultString(ret)}`);
  return toInt32(ret);
}
...
const $init = (() => {
  let gen = (function* init () {
    ...
    ({ exports: exports0 } = yield instantiateCore(yield module0, {
      $root: {
        '[static]wasip1.environ-get-import': trampoline0,
        '[static]wasip1.environ-sizes-get-import': trampoline1,
